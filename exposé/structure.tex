...
\definecolor{TUBlue}{RGB}{0,48,94} %TU_Dresden Corporate coloring
...
\usepackage[export]{adjustbox} % Easy image ragging
...
\newcommand{\HorRule}{\color{TUBlue}\rule{\linewidth}{1.5pt}} % Defines the horizontal rule around the title

\pretitle{
	\vspace{-30pt} % Move the entire title section up
	\includegraphics[width=0.3\textwidth, right]{img/tud.pdf}
